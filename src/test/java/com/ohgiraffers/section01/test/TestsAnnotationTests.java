...
public class TestsAnnotationTests {
     ...
     * 3. Junit Vintage
     * -Juit3, 4를 기반으로 돌아가는 테스트 엔진을 제공해준다.(하위 호환용)
     */
    ...
    public TestsAnnotationTests(){}

    //public TestsAnnotationTests(int value) {}
    ...
    * 필기 기본적으로 테스트 이름은 메소드 이름을 따라가지만 @DisplayName에 설정한 이름으로 이름을 표기해준다.
    ...
    public void 테스트_메소드2(){
        ...
        * 단, @DisplayName과 중복 작성 시에는 @DisplayName에 부여한 테스트 우선권을 가진다.
         */
    }
}
